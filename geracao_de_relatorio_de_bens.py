...
image_dir = "C:/yo/local/py/geracao_de_relatorio_de_bens/imagens/"

# define o arquivo csv
csv_filepath = "C:/yo/local/py/geracao_de_relatorio_de_bens/catalogo.csv"

# define o arquivo html de destino
html_filepath = "C:/yo/local/py/geracao_de_relatorio_de_bens/relatorio_de_bens.html"
